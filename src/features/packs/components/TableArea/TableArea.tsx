...
import { /* CardPackType, */ testPack } from 'features/packs/packs-api';
...
export const TableArea = React.memo(
  (/* props: TableAreaPropsType */): React.ReactElement => {
    // const { packs } = props;
